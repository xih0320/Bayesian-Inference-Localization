...
**Usage:**
```python
from hmm_temporal_inference import forward, smooth, viterbi
smoothed = smooth(forward_msgs, backward_msgs)
path = viterbi(evidence, transition_model, observation_model, prior)
```
